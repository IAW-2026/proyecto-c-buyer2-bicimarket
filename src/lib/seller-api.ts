...
const MOCK_PRODUCTS: SellerProduct[] = [
  // ─── BiciShop Buenos Aires ───────────────────────────────
  {
    ...
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Orbea_Occam_2020.jpg/250px-Orbea_Occam_2020.jpg",
    status: "active",
  ...
  },
  {
    ...
    seller_profile_id: "sel_mock_001",
    seller_name: "BiciShop Buenos Aires",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Casque_v%C3%A9lo_de_course.jpg/250px-Casque_v%C3%A9lo_de_course.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    seller_profile_id: "sel_mock_001",
    seller_name: "BiciShop Buenos Aires",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/RacingBicycle-non.JPG/330px-RacingBicycle-non.JPG",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    seller_profile_id: "sel_mock_001",
    seller_name: "BiciShop Buenos Aires",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Fahrradlampe-led.jpg/250px-Fahrradlampe-led.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  ...
  // ─── Urban Bike Store ────────────────────────────────────
  {
    ...
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Brosen_city_bicycle.jpg/250px-Brosen_city_bicycle.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    seller_profile_id: "sel_mock_002",
    seller_name: "Urban Bike Store",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Chase-ACT-Carbon-1.jpg/250px-Chase-ACT-Carbon-1.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    seller_profile_id: "sel_mock_002",
    seller_name: "Urban Bike Store",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Electric_Wheels_in_Fort_Lauderdale%2C_Florida.jpg/330px-Electric_Wheels_in_Fort_Lauderdale%2C_Florida.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    seller_profile_id: "sel_mock_002",
    seller_name: "Urban Bike Store",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Generic_u-lock.jpg/250px-Generic_u-lock.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  ...
  // ─── Ciclos del Sur ──────────────────────────────────────
  {
    ...
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Look_765_Gravel_Bicycle.jpg/250px-Look_765_Gravel_Bicycle.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    seller_profile_id: "sel_mock_003",
    seller_name: "Ciclos del Sur",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/Suncross_Sweetie%2C_Eurobike_2024%2C_Frankfurt_am_Main_%28EB245525%29.jpg/250px-Suncross_Sweetie%2C_Eurobike_2024%2C_Frankfurt_am_Main_%28EB245525%29.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    seller_profile_id: "sel_mock_003",
    seller_name: "Ciclos del Sur",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Bike_pump.jpg/250px-Bike_pump.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    seller_profile_id: "sel_mock_003",
    seller_name: "Ciclos del Sur",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Fahrradgepaecktraeger.jpg/250px-Fahrradgepaecktraeger.jpg",
    status: "active",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
